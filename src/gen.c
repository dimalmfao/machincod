...
void emit_func_call(Expression_t *expr)
{
    ...
    unsigned int pos = 0;
    static unsigned int nested_c = 0;  // nested function call count, make this static to avoid
                                       // stack corruption when calling a function
                                       // inside another function call.
                                       // TODO: transform systemwide this into nullablz
