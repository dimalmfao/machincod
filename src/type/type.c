...
get_type(Token_t **token)
{
    ...
    if (strcmp(tok->value.p, Machincod_ReservedKeywords[KW_INT]) == 0)
    {
        type.t = INTEGER;
    }

    else if (strcmp(tok->value.p, Machincod_ReservedKeywords[KW_BYTE]) == 0)
    {
        type.t = _BYTE;
    }

    else if (strcmp(tok->value.p, Machincod_ReservedKeywords[KW_VOID]) == 0)
    {
    ...
    else if (strcmp(tok->value.p, Machincod_ReservedKeywords[KW_CHAR]) == 0)
    {
        type.t = _CHAR;
    }

    else if (strcmp(tok->value.p, Machincod_ReservedKeywords[KW_STR]) == 0)
    {
        type.t = STRING;
    }

    else if (strcmp(tok->value.p, Machincod_ReservedKeywords[KW_FLOAT]) == 0)
    {
        type.t = _FLOAT;
    }

    else if (strcmp(tok->value.p, Machincod_ReservedKeywords[KW_BOOL]) == 0)
    {
        type.t = _BOOL;
    }
